  ...
  const scrollToFirstError = () => {
    setTimeout(() => {
      const errorElement = document.querySelector(
        ".input-error, .field-error-message, .message-error, .step-error, .error-message, .error"
      );
      if (errorElement) {
          ...
          if (profile) {
            ...
            if (profile.isBusinessProfile) {
              formik.setValues({
                ...
                businessCategory: profile.businessCategoryId || (profile.businessCategory && /^[0-9a-fA-F]{24}$/.test(profile.businessCategory) ? profile.businessCategory : "") || "",
        ...
        try {
          ...
          if (data.success && data.data && data.data.profile) {
            ...
            const updates = profile.isBusinessProfile ? {
              ...
              businessCategory: profile.businessCategoryId || (profile.businessCategory && /^[0-9a-fA-F]{24}$/.test(profile.businessCategory) ? profile.businessCategory : "") || currentValues.businessCategory || "",
